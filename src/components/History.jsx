...
export function HistoryVideos() {
  ...
  useEffect(() => {
    ...
    axios.get(`${process.env.REACT_APP_API_URL}/get-history/${userid}`).then(response => {
      ...
      <div id="user-dashboard-grid">
        <div id="nav-panel">
          <div id="menu-con">
            ...
            <div className="btns-con"><Link id="nav-item-4" to={`/history/${cookies['userid']}`} className="btn btn-danger btns bi bi-clock-history"> History</Link></div>
          </div>
          <div id="user-dash-category-con">
            <div id="user-dash-category-sub-con">
              ...
              <div className="p-3 text-light fw-bold ">
                <div id="pageTitle" className="text-center"> History</div>
