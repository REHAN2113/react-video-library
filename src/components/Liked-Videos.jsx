...
export function LikedVideos() {
  ...
  useEffect(() => {
    ...
    axios.get(`${process.env.REACT_APP_API_URL}/get-likedvideos/${userid}`).then(response => {
      ...
      <div id="user-dashboard-grid">
        <div id="nav-panel">
          <div id="menu-con">
            ...
            <div className="btns-con" ><Link id="nav-item-2" to={`/liked-videos/${cookies['userid']}`} className="btn btn-danger btns  bi bi-hand-thumbs-up"> Liked's</Link></div>
          ...
          <div id="user-dash-category-con">
            <div id="user-dash-category-sub-con">
              ...
              <div className="p-3 text-light fw-bold ">
                <div id="pageTitle" className="text-center"> Liked Videos</div>
